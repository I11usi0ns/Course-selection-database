...
create table Pre_requisite
	(id_first int, -- The prerequisite course
     id_second int, -- The course that requires a prerequisite
     primary key (id_first,id_second),
     foreign key (id_second) references Courses (course_id)
		on delete cascade
	);
...
create table Anti_requisite
	(id_1 int,
     ...
     foreign key (id_1) references Courses (course_id)
		on delete cascade
	);
